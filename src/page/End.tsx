      ...
      <div className="grid grid-row-2 h-screen">
        <div className="grid-row-1 m-8">
          <div className="flex justify-center h-full">
            <img
              className="w-[100px] h-[100px] mt"
              src="https://seon5.github.io/signahand/assets/images/folder.png"
              style={{
                position: "fixed",
                left: "48%",
                top: "360px",
        ...
        <div className="grid-row-1 m-8">
          <div className="flex flex-col items-center justify-center h-full">
            <div className="text-3xl font-nomal mb-4">
              다른 파일도 이용하고 싶다면?
            </div>
            <Link
              to="/"
              className="btn w-[600px] h-[123px] text-xl text-center text-white text-[50px] font-extrabold bg-red-500 rounded-[30px]"
            >
              처음 페이지로
            </Link>
          </div>
